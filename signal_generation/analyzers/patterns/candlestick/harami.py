...
class HaramiPattern(BasePattern):
    ...
    def detect(
        ...
        """
        Detect Harami pattern in last N candles using TALib.
    ...
    def _get_detection_details(self, df: pd.DataFrame) -> Dict[str, Any]:
        """
        Get additional details about Harami detection with recency information.
        ...
        base_confidence = min(0.70 - (size_ratio * 2), 0.90)
